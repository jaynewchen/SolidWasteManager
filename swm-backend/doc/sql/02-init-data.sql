-- ============================================================
-- Solid Waste Management System - Initial Data
-- 固废管理系统 - 初始化数据
-- ============================================================
...
-- 1. Dashboard
INSERT INTO sys_menu (id, parent_id, menu_name, menu_type, permission, path, component, icon, sort_order, visible, status) VALUES
...
-- Button permissions for receiving
...
(2, 5),  -- receiving:add
(2, 6),  -- receiving:edit
(2, 7),  -- receiving:delete
(2, 8),  -- receiving:export
(2, 14), -- 贮存台账 (M)
(2, 15), -- 贮存列表 (C)
(2, 16), -- storage:add
(2, 17), -- storage:edit
